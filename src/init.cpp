 ...
 * between garlicoind, and garlicoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/garlicoin/garlicoin>";
...
/** Sanity checks
 *  Ensure that garlicoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single garlicoin process is using the data directory.
